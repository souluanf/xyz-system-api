...
public interface UserController {
    ...
    @GetMapping(value = USER_V1_ID)
    ResponseEntity<UserResponse> findByUsername(
    ...
    @DeleteMapping(value = USER_V1_ID)
